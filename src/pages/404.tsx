...
const FourOFour: NextPage = () => {
  return (
    <>
      <Head>
        <title>OpenLuncher - Something went wrong</title>
        <meta name="description" content="Something went wrong" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main className="flex min-h-screen flex-col items-center justify-center bg-white dark:bg-slate-900">
        <div className="mx-auto flex h-full w-full max-w-[50rem] flex-col">
          ...
          <div className="py-10 px-4 text-center sm:px-6 lg:px-8">
            <h1 className="block text-7xl font-bold text-gray-600 dark:text-slate-200 sm:text-9xl">
              404
            </h1>
            ...
            <div className="mt-5 flex flex-col items-center justify-center gap-2 sm:flex-row sm:gap-3">
              <Link
                ...
                href="https://github.com/kitravee/openluncher-t3"
                target="_blank"
              >
                <svg
                  className="h-4 w-4"
